...
enum DemoGeometry {
    static func quartzRect(_ appKitRect: CGRect, primaryTop: CGFloat) -> CGRect {
    ...
    static func destinationFrame(window: CGRect, source: CGRect, destination: CGRect) -> CGRect? {
    ...
    static func contains(_ window: CGRect, in visibleFrame: CGRect) -> Bool {
