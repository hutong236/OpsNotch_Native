...
- [x] Split the ordinary hidden-section toggle and spacer into independent `NSStatusItem`s.
- [x] Initialize stable preferred-position defaults before status-item creation.
